...
public class MatchImageDialog extends AlertDialog
{
	protected MatchImageDialog(Activity context, int imageID) {
		super(context);
...
//    	setTitle();
	...
	private void calculateDialogSize()
	{
    	...
    	_titleHeight = 0;//Utilities.scalePixels2(_metrics, 67);//Utilities.scalePixels(_metrics, 100);
	...
	private void createImageView()
	{
		...
		if (_frameLayout != null)
		{
	    	...
	    	if (VERSION.SDK_INT > 4)
	    	{
				...
				_touchView.setBackgroundColor(Color.rgb(255, 255, 255));
				Matrix m = new Matrix();
	    	...
	    	else
	    	{
	    		...
	    		_imageView.setBackgroundColor(Color.rgb(255, 255, 255));
